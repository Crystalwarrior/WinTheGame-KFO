...
init:
    ...
    $ event("ai_scene", "Ai.loc == loc and Ai.alive and Ai.met and not Ai.hidden and not freeplay", event.only(), priority=70)
    $ event("find_hitomo", "Hitomo.loc == loc and Hitomo.alive and Hitomo.loc == a2 and not Hitomo.met and not freeplay", event.once(), priority=65)
