...
label game_init_chars:
    python:
        ...
        Lucy = char("Lucy", "Kanagaki", "Female","Homemaking","Mixed girl with an obsession for boy idols.","fixed","girl6", bow, None, lucy, "I see a light ... Shall I go ... towards ... it?", "scream_girl1", "Lucy scared", "Lucy sad",rm_bathhouse)
